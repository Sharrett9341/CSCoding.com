         ...
         <section id="blogpost">
             <div class="card">
                 <div class="card-meta-blogpost">
                     Posted by <strong> <?php the_author();?> </strong> on <?php the_time('F J, Y') ?> <?php if(get_post_type() == 'post'){ ?>
    ...
    '" size="30"' . $aria_req . ' />',
                        ...
                        $args = array(
                            ...
                            'comment_field' => '<textarea placeholder="Your Comment" id="comment" name="comment" cols="45" rows="8" aria-required="true">' .
                             '</textarea>',
                            'comment_notes_before' => '<p class="comment-notes">Your Email address will not be publised. All fields are required.</p>'
